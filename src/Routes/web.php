...
Route::group(['prefix' => config("laravel-blog.route_prefix"), 'middleware' => 'web'], function() {
    ...
    if (config("laravel-blog.intranet")) {
        
        Route::get("/", "Lnch\LaravelBlog\Controllers\BlogPostIntranetController@index");

        Route::get(config("laravel-blog.posts.taxonomy")."/scheduled",
            "Lnch\LaravelBlog\Controllers\BlogPostIntranetController@scheduled");
        Route::resource(config("laravel-blog.posts.taxonomy"),
            "Lnch\LaravelBlog\Controllers\BlogPostIntranetController");
